            ...
            <div className="contenedor">
                <div className="card">
                    ...
                    <div className="face back">
                        <h3>Requisitos para Diplomados</h3>
                        <p>- Título en Provisión Nacional. <br/>
                            - Fotocopia Diploma Académico. <br/>
                            - Carnet de Identidad. <br/>
                            - Certificado de Nacimiento actualizado. <br/>
                            - Currículum Vitae sin documentar. <br/>
                ...
                <div className="cardcontenido">
                    <div className="face front">
                        ...
                        <h3>Lugar: Cochabamba - Modalidad: ON LINE / SEMIPRESENCIAL</h3>                        
                    </div>
                </div>
                <div className="cardcontenido">
                    <div className="face front">
                ...
                <div className="cardcontenido">
                    <div className="face front">
                        ...
                        <h3>Lugar: La Paz - Modalidad: ON LINE / SEMIPRESENCIAL</h3>                        
                    </div>
                </div>
                <div className="cardcontenido">
                    <div className="face front">
                ...
                <div className="cardcontenido">
                    <div className="face front">
                        ...
                        <h3>Lugar: Santa Cruz - Modalidad: ON LINE / SEMIPRESENCIAL</h3>                        
                    </div>
                </div>
                <div className="cardcontenido">
                    <div className="face front">
