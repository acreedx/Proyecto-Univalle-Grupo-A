...
import CardGray from "../../components/card-gray";
    ...
    <main className="h-full grid gap-16">
      ...
      <div className={style.description}>
        <div className={style["description-item"]}>
          <h5 className="mb-2 text-3xl font-bold tracking-tight text-white dark:text-white text-center">
            Requisito 1
          </h5>
          <p className="font-normal text-lg text-white dark:text-white text-center">
