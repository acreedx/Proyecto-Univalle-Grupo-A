  ...
  return (
    <div className="col-span-5 mb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="flex flex-col items-center justify-center p-6 bg-gray-500 border rounded-2xl shadow text-white ml-1 md:ml-4">
        ...
        <div className="flex flex-col items-center justify-center p-2 bg-gray-500 border rounded-2xl shadow text-white mx-2">
        ...
        <div className="flex flex-col items-center justify-center p-6 bg-gray-500 border  rounded-2xl shadow text-white mr-1 md:mr-4">
