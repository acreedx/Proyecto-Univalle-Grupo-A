  ...
  return (
    <main className="h-full grid gap-5">
      ...
      <ul className="flex items-center py-5 p-4 gap-4 justify-center">
        ...
        <ButtonNav
          href="/servicios/cafeteriaMenu/cafeteriaMenuJugos"
          text="Jugos/Batidos"
        />
        <ButtonNav
          href="/servicios/cafeteriaMenu/cafeteriaMenuPostres"
          text="Postres"
        />
        <ButtonNav
          href="/servicios/cafeteriaMenu/cafeteriaMenuCafes"
          text="Cafés"
        />
        <ButtonNav
          href="/servicios/cafeteriaMenu/cafeteriaMenuDesayunos"
          text="Desayunos"
        />
        <ButtonNav
          href="/servicios/cafeteriaMenu/cafeteriaMenuSandwiches"
          text="Sandwiches"
        />
        <ButtonNav
          href="/servicios/cafeteriaMenu/cafeteriaMenuEspeciales"
          text="Especiales"
        />
        <ButtonNav
          href="/servicios/cafeteriaMenu/cafeteriaMenuEnsaladas"
          text="Ensaladas"
        />
      </ul>
